...
namespace SimpleDemo
{
    ...
    public class MainViewModel : BaseViewModel
    {
        ...
        public MainViewModel()
        {
            ...
            //using (FileStream fs = File.Open(@"D:\Gumi\Toi-System\shinnichiro_toi_cs\ToiManager\bin\Debug\file\3BF_3TH_0_User1_20210305120553\CoreTOICube.xyz", FileMode.Open, FileAccess.Read, FileShare.ReadWrite))
            ...
            //    {
            //        string[] arrStr1 = line.Split(new Char[] { ' ' });
            //        Point3D p3D = new Point3D(Math.Round(float.Parse(arrStr1[0]), 5), Math.Round(float.Parse(arrStr1[1]), 5), Math.Round(float.Parse(arrStr1[2]), 5));
            ...
            using (FileStream fs = File.Open(@"D:\Gumi\Toi-System\shinnichiro_toi_cs\ToiManager\bin\Debug\file\3BF_3TH_0_User1_20210305120553\ShellTOICube.xyz", FileMode.Open, FileAccess.Read, FileShare.ReadWrite))
            using (BufferedStream bs = new BufferedStream(fs))
            using (StreamReader sr = new StreamReader(bs))
            {
                string line;
                while ((line = sr.ReadLine()) != null)
                {
                    ...
                    ptPos.Add(new Vector3(float.Parse(arrStr1[0]), float.Parse(arrStr1[1]), float.Parse(arrStr1[2])));
                }
            }
            ...
            PointsTransform = new Media3D.TranslateTransform3D(0, 0, 0);
